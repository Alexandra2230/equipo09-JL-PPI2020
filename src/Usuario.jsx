 ...
 function Usuario(){
  ...
  <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
        ...
        <div class="form-group">
          ...
          <button type="button" className=" btn-lg  "> <b>Guardar Cambios</b></button>
          <button type="button" className=" btn-lg  "> <b>Cerrar Sesiòn</b></button>
        </div>
        </form> 
    )
    }
